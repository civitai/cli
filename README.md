...
**It also reproduces both sides of the bracket above**, which is the part that matters more
than where it came from — a body limit bites on ~4/3 of the compressed size:
