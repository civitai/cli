...
⚠ The server will NOT use the checkpoint you asked for. It has substituted a
  ...
  been submitted or charged yet.
    requested version 999999999 -> ran version 2436219  (reason: unrecognized)
...
| `--fail-on-substitution` and the server reported it would run a different checkpoint (see [Silent model substitution](#-silent-model-substitution)) | `1` |
